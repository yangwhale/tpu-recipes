...
# TPU: tpu7x-4x4x8 (128 chips / 256 devices / 32 hosts)
...
export WORKLOAD_NAME="$(printf "%.26s" "${USER//_/-}-ds3-fp8-4x4x8")-$(date +%Y%m%d-%H%M)"

echo "=========================================="
echo "Submitting DeepSeek3-671B FP8 Training (4x4x8)"
echo "=========================================="
echo "Workload Name: ${WORKLOAD_NAME}"
echo "Docker Image:  ${WORKLOAD_IMAGE}"
echo "TPU Type:      tpu7x-4x4x8 (128 chips)"
echo "Precision:     fp8_full"
echo "Output Dir:    ${BASE_OUTPUT_DIR}"
echo ""

# XLA Flags (from run_recipe.sh)
XLA_FLAGS=" \
...
# MaxText 参数 (fp8 版本 - 与 bf16 的差异: 增加 quantization 和 tile 参数)
MAXTEXT_ARGS="\
