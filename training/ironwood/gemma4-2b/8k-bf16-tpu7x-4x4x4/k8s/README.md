# Pretrain gemma4-2b workload on Ironwood GKE clusters with Kubernetes JobSet
...
export WORKLOAD_NAME="$(printf "%.26s" "${USER//_/-}-gemma4-2b")-$(date +%Y%m%d-%H%M)"
```

### 2. Run gemma4-2b Pretraining Workload
