...
export WORKLOAD_NAME="$(printf "%.26s" "${USER//_/-}-ds3-671b-4096-4x8x8")-$(date +%Y%m%d-%H%M)"

echo "=========================================="
echo "Submitting DeepSeek3-671B Training (4x8x8)"
echo "=========================================="
...
# MaxText 参数 (4x8x8 版本 - 注意与 4x4x8 的差异)
MAXTEXT_ARGS="\
